...
function M.nmap(first)
  return M.map 'n'(first)
end
function M.vmap(first)
  return M.map 'v'(first)
end
function M.cmap(first)
  return M.map 'c'(first)
end
function M.xmap(first)
  return M.map 'x'(first)
end
